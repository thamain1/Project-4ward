...
See [`docs/VISION.md`](docs/VISION.md) for the full architecture, phasing, and decisions.

> Status: **Phase 0 (provisioning)** — not yet scaffolded. This folder + the vision doc are the
> first artifacts. Build begins after the architecture brief is blessed.
